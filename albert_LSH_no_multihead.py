...
class AlbertAttention(BertSelfAttention):
    ...
    def forward(self, input_ids, attention_mask=None, head_mask=None):
        ...
        # qk = torch.matmul(query_layer, key_layer.transpose(-1, -2))
        # attention_scores = qk / math.sqrt(self.attention_head_size)
        # print(*qk.shape)
        ...
        context_layer, attention_probs, buckets = attn(mixed_query_layer, mixed_value_layer) 
        ...
        context_layer = self.transpose_for_scores(context_layer)
        # print("context_layer")
        # print(len(context_layer))
        # print(len(context_layer[0]))
        # print(len(context_layer[0][0]))
        # print(len(context_layer[0][0][0]))
